...
extension UserDefaults {
    ...
    var nightscoutURL: URL? {
        get { url(forKey: Key.baseURL) }
        set {
            guard let newValue else {
                removeObject(forKey: Key.baseURL)
                return
            }
            set(newValue, forKey: Key.baseURL)
        }
    }
    ...
    var showBGDeltaMenuItemState: NSControl.StateValue? {
        ...
        set { set(newValue?.rawValue, forKey: Key.showBGDeltaMenuItemState) }
    }
    ...
    var showBGTimeMenuItemState: NSControl.StateValue? {
        ...
        set { set(newValue?.rawValue, forKey: Key.showBGTimeMenuItemState) }
    }
}
